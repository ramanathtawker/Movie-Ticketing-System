 ...
 * NewJFrame4.java
 *
 * Created on Aug 22, 2018, 5:49:11 PM
 */
    ...
    public NewJFrame4() {
       ...
       try{
           ...
           Class.forName("java.sql.DriverManager");
                ...
                ResultSet rs=st.executeQuery("SELECT *FROM CHENNAI WHERE MOVIENAME='MOVIESANDA1200'");
                while(rs.next())
                {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       }if(jCheckBox30.isSelected())
       {
        ...
        if((jComboBox1.getSelectedIndex()+1)==a)
        {
            ...
            try{
               int response=JOptionPane.showConfirmDialog(null,"Want to Proceed? \n (Once Proceeded PAYMENT HAS TO BE MADE)");
               if(response==JOptionPane.YES_OPTION)
               {
                Class.forName("java.sql.DriverManager");
                Connection con1=DriverManager.getConnection("jdbc:mysql://localhost/mydb","root","");
                Statement st=con1.createStatement();
             String SQL="SELECT * FROM CHENNAI WHERE MOVIENAME='MOVIESANDA1200'";
            ...
            if(jCheckBox1.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT1=0 WHERE MOVIENAME='MOVIESANDA1200' ";
            ...
            if(jCheckBox2.isSelected())
            {
                String SQL2="UPDATE  CHENNAI SET SEAT2=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL2);
                seatSelected=seatSelected+"A2 ";
            }
            if(jCheckBox3.isSelected())
            {
                String SQL3="UPDATE  CHENNAI SET SEAT3=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL3);
                seatSelected=seatSelected+"A3 ";
            }
            if(jCheckBox4.isSelected())
            {
                String SQL4="UPDATE  CHENNAI SET SEAT4=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL4);
                seatSelected=seatSelected+"A4 ";
            }
            if(jCheckBox5.isSelected())
            {
                String SQL5="UPDATE  CHENNAI SET SEAT5=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL5);
                seatSelected=seatSelected+"A5 ";
            }
            if(jCheckBox6.isSelected())
            {
                String SQL6="UPDATE  CHENNAI SET SEAT6=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL6);
                seatSelected=seatSelected+"A6 ";
            }
            if(jCheckBox7.isSelected())
            {
                String SQL7="UPDATE  CHENNAI SET SEAT7=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL7);
                seatSelected=seatSelected+"B1 ";
            }
            if(jCheckBox8.isSelected())
            {
                String SQL8="UPDATE  CHENNAI SET SEAT8=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL8);
                seatSelected=seatSelected+"B2 ";
            }
            if(jCheckBox9.isSelected())
            {
                String SQL9="UPDATE  CHENNAI SET SEAT9=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL9);
                seatSelected=seatSelected+"B3 ";
            }if(jCheckBox10.isSelected())
            {
                String SQL10="UPDATE  CHENNAI SET SEAT10=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL10);
                seatSelected=seatSelected+"B4 ";

            }if(jCheckBox11.isSelected())
            {
                String SQL11="UPDATE  CHENNAI SET SEAT11=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL11);
                seatSelected=seatSelected+"B5 ";
            }
            if(jCheckBox12.isSelected())
            {
                String SQL12="UPDATE  CHENNAI SET SEAT12=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL12);
                seatSelected=seatSelected+"B6 ";
            }
            if(jCheckBox13.isSelected())
            {
                String SQL13="UPDATE  CHENNAI SET SEAT13=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL13);
                seatSelected=seatSelected+"C1 ";
            }
            if(jCheckBox14.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT14=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"C2 ";
            }
            if(jCheckBox15.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT15=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"C3 ";
            }
            if(jCheckBox16.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT16=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"C4 ";
            }
            if(jCheckBox17.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT17=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"C5 ";
            }
            if(jCheckBox18.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT18=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"C6 ";
            }
            if(jCheckBox19.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT19=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"D1 ";
            }
            if(jCheckBox20.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT20=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"D2 ";
            }
            if(jCheckBox21.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT21=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"D3 ";
            }
            if(jCheckBox22.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT22=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"D4 ";
            }
            if(jCheckBox23.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT23=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
            ...
            if(jCheckBox24.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT24=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"D6 ";
            }
            if(jCheckBox25.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT25=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"E1 ";
            }
            if(jCheckBox26.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT26=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"E2 ";
            }
            if(jCheckBox27.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT27=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"E3 ";
            }
            if(jCheckBox28.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT28=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"E4 ";
            }
          if(jCheckBox29.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT29=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
                seatSelected=seatSelected+"E5 ";
            }
            if(jCheckBox30.isSelected())
            {
                String SQL1="UPDATE  CHENNAI SET SEAT30=0 WHERE MOVIENAME='MOVIESANDA1200' ";
                st.executeUpdate(SQL1);
